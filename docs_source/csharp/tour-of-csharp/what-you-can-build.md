...
source_path: docs/csharp/tour-of-csharp/what-you-can-build.md
...
- **Learn the language**: Start with the [beginner C# tutorials](tutorials/index.md) to learn C# fundamentals.
- **Explore C#**: Read [A tour of C#](overview.md) for an overview of key language features.
- **Dive into fundamentals**: Visit the [C# fundamentals](../fundamentals/program-structure/index.md) section for deeper coverage of the type system, object-oriented programming, and more.
- **Coming from another language?** See the roadmaps for [Java](tips-for-java-developers.md), [JavaScript/TypeScript](tips-for-javascript-developers.md), or [Python](tips-for-python-developers.md) developers.
