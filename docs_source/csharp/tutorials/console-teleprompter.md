...
source_path: docs/csharp/tutorials/console-teleprompter.md
...
Learn more about the [`async Main` method](../fundamentals/program-structure/main-command-line.md#main-return-values) in our fundamentals section.
