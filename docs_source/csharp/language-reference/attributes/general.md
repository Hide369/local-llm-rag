...
source_path: docs/csharp/language-reference/attributes/general.md
...
You can apply several attributes to elements in your code to add semantic meaning to those elements:
