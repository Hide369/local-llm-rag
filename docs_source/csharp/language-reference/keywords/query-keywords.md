...
source_path: docs/csharp/language-reference/keywords/query-keywords.md
...
- [where](where-clause.md): Filters source elements based on one or more Boolean expressions separated by logical AND and OR operators (`&&` or `||`).
