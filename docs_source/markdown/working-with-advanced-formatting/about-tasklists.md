...
source_path: content/get-started/writing-on-github/working-with-advanced-formatting/about-tasklists.md
...
> [!IMPORTANT]
> Tasklist blocks are . You can read more about this on the [ Blog](https://github.blog/changelog/2025-02-18-github-issues-projects-february-18th-update/).
>
...
You can use Markdown to create a tasklist in any comment on . If you reference an issue, pull request, or discussion in a tasklist, the reference will unfurl to show the title and state.
...
* To help you track your team's work on an issue, the progress of an issue's tasklist appears in various places on , such as a repository's list of issues.
...
You can reorder tasks across different lists in the same comment, but you cannot reorder tasks across different comments.
 ...
 ![Screenshot of a  issue showing two tasks in a tasklist. A grid of six dots to the left of the second task is outlined in dark orange.](/assets/images/help/writing/task-list-reorder.png)
