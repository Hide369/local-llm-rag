---
name: python-spec
source_path: docs/pg_data/python-language-reference-unified.md
sha256: c132f5cd086e9049c2081d127dcc20fd62c92c22cc8c8d8e66ae1aea9fa13fae
...
## 3.2.4. [`numbers.Number`](https://docs.python.org/3/library/numbers.html#numbers.Number)
...
## 3.2.4.1. [`numbers.Integral`](https://docs.python.org/3/library/numbers.html#numbers.Integral)
...
## 3.2.4.3. [`numbers.Complex`](https://docs.python.org/3/library/numbers.html#numbers.Complex) ([`complex`](https://docs.python.org/3/library/functions.html#complex))
...
## 3.3.5.1. The purpose of *\_\_class_getitem\_\_*
